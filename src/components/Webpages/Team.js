...
//         <p>Team member</p>
//       </div>
//       <div className="w-44 h-40 bg-white">
//         {
//           Team && Team.length > 0 ? Team.map((data,index)=>{
//             return(
//               <div key={index} className="flex w-40 h-40 bg-white">
//                 <img src={data.image} alt='image'></img>
//                 <p>{data.name}</p>
//                 <p>{data.postion}</p>
//                 <div className="flex">
//                   <p>{data.socialmedia.facebook}</p>
//                   <p>{data.socialmedia.instagram}</p>
//                   <p>{data.socialmedia.linkecin}</p>
